...
assign awready_mux = bridge_sel ? bg_axi_awready : mem_sel    ? dm_axi_awready : 1'b0;

assign wready_mux = bridge_sel ? bg_axi_wready : mem_sel    ? dm_axi_wready : 1'b0;

assign bvalid_mux = bridge_sel ? bg_axi_bvalid : mem_sel    ? dm_axi_bvalid : 1'b0;

assign bresp_mux = bridge_sel ? bg_axi_bresp : mem_sel    ? dm_axi_bresp : 3'b000;

assign arready_mux = bridge_sel ? bg_axi_arready : mem_sel    ? dm_axi_arready : 1'b0;

assign rvalid_mux = bridge_sel ? bg_axi_rvalid : mem_sel    ? dm_axi_rvalid : 1'b0;

assign rdata_mux = bridge_sel ? bg_axi_rdata : mem_sel    ? dm_axi_rdata : 32'd0;

assign rresp_mux = bridge_sel ? bg_axi_rresp : mem_sel    ? dm_axi_rresp : 3'b000;
...
begin
    ...
    begin
        ...
        begin
            ...
            if(awready_mux && 
               ((bridge_sel && bg_axi_awvalid) ||
                (mem_sel    && dm_axi_awvalid)))
            begin
            ...
            if(wready_mux &&
               ((bridge_sel && bg_axi_wvalid) ||
                (mem_sel    && dm_axi_wvalid)))
            begin
...
assign rdata_mux = (target_slave == BRIDGE_SEL) ? bg_axi_rdata : dm_axi_rdata; // out put signal line 
